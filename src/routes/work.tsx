...
function Work() {
  return (
    <>
      ...
      <section className="bg-white py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-14 max-w-3xl">
            <p className="text-[13px] uppercase tracking-[0.15em] font-medium mb-5 text-[#175E52]">
              Recent projects · {projects.length}
            </p>
            <h2 className="text-4xl md:text-5xl font-semibold tracking-tight text-[#10201C] leading-[1.05] text-balance">
      ...
      {/* Detailed case rows */}
      <section className="bg-[#F2F0E9] py-24">
              ...
              >
                  ...
                  {shot ? (
                    ...
                    <div className="absolute inset-0 grid place-items-center">
                      <div className="text-center px-6">
                        ...
                        <p className="mt-3 text-[11px] uppercase tracking-[0.22em] text-[#5C6864]">Case study</p>
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div>
                  <div className="flex items-center gap-2.5 mb-4">
                    ...
                    <span className="text-[11px] uppercase tracking-[0.22em] text-[#175E52]">{p.badge}</span>
                  </div>
                  <h3 className="text-3xl md:text-4xl font-semibold text-[#10201C] tracking-tight leading-tight">
                    {p.name}
                  </h3>
                  <p className="mt-2 text-sm text-[#5C6864]">{p.industry}</p>
                  <p className="mt-5 text-[16px] text-[#3F4B47] leading-relaxed">{p.description}</p>

                  <div className="mt-6">
                    <p className="text-[11px] uppercase tracking-[0.22em] text-[#5C6864] mb-3">Services delivered</p>
                    <ul className="flex flex-wrap gap-2">
                      {p.services.map((s) => (
                        <li
                          key={s}
                          className="text-[12px] rounded-full border border-black/8 bg-[#F2F0E9] text-[#10201C] px-3 py-1.5"
                        >
                          {s}
                        </li>
                      ))}
                  ...
                  {p.tech && (
                    <div className="mt-5">
                      <p className="text-[11px] uppercase tracking-[0.22em] text-[#5C6864] mb-3">Stack & capabilities</p>
